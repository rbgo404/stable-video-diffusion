...
class InferlessPythonModel:
    ...
    def infer(self,inputs):
        ...
        export_to_video(frames, self.temp_video_file, fps=7)

        with open(self.temp_video_file, "rb") as video_file:
